...
class Utils:
    ...
    def __init__(
        ...
        try:
            ...
            raise FilePathError(definitions_path, resources_path)
    ...
    def clean_env_vars(self, string):
        ...
        if string is None or string == "None" or string == "":
            return None
        return None
    ...
    def render_templates(self, template:str, definition:dict, iac_action:str, obj_name:str = "NA") -> str:
        ...
        try:
            ...
            if missing_vars:
                raise TemplateFileError(obj_name, self.resources_path, f"Definition is missing variables: {missing_vars}")
            ...
            raise TemplateFileError(obj_name, self.resources_path, e)
    ...
    def create_db_sys_connection(self, database_system:str):
        ...
        try:
            ...
            raise FilePathError(self.resources_path)
        ...
        private_key_path:str = db_sys_engine["sqlalchemy.connect_args"].get("private_key_path",None)
        private_key:str = db_sys_engine["sqlalchemy.connect_args"].get("private_key","")
        private_key_passphrase:str = db_sys_engine["sqlalchemy.connect_args"].get("private_key_passphrase","")
